"""This file is copied from an existing NI-VISA measurement plug-in example.

This module provides helper functions for interacting with the gRPC device server to share
instrument sessions. You can find the original file at the link below. 

https://github.com/ni/measurement-plugin-python/blob/main/examples/nivisa_dmm_measurement/_visa_grpc.py
"""
